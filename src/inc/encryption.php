...
class Encryption {
    ...
    public function decrypt($str) {
        ...
        $hash       = hash_hmac(self::HASHING_ALGORITHM, $cipherText, $this->key, true);
        if (hash_hmac(self::HASHING_ALGORITHM, $cipherText, $this->key, true) === $hash && strlen($str) >= 16) {
            return openssl_decrypt($cipherText, self::ENCRYPTION_ALGORITHM, $this->key, OPENSSL_RAW_DATA, $iv);
        }
    }
}
